	...
	% GDP Growth by Component
		\indent \begin{tikzpicture}
			...
			\addplot[thick, color=black] table [x=date, y=gdp, col sep=comma] {data/gdp.csv}
				node[pos=0.48,pin=270:{Real GDP Growth}] {};	
			\node[align=center, below, shift=({3.4cm,-0.25cm})] {
				\input{data/gdp.txt}};
...
\section{Inflation and Prices}
	...
	% CPI Components
		\begin{tikzpicture}[trim axis right]
		    ...
		    \bbar{x}{0}, legend style={at={(0.26,0.92)}}, legend cell align=left,
...
\indent \begin{tikzpicture}
		...
		\begin{tikzpicture}[trim axis right]
			...
			\addplot[thick, dashed, color=red!50!black] table [x=date, y=Large, col sep=comma] 
				{data/tankan_bc.csv} node[pos=0.22,pin=60:{Large firms}] {};	 	
	...
	% Earnings per share
		\indent \begin{tikzpicture}
			...
			\addplot[thick, color=black] table [x=date, y=total_ch, col sep=comma] {data/cons.csv}
				node[pos=0.26,pin=90:{Total change}] {};	
		...
		% Current account balance
			...
			\addplot[thick, color=black] table [x=date, y=total_ch, col sep=comma] {data/inv.csv}
				node[pos=0.4,pin=90:{Total change}] {};	
			\node[align=left, below, shift=({2.7cm,0cm})] {
				\input{data/inv.txt}};
...
\vspace{8mm}
	...
	% Title: 	
		\ct[Foreign exchange, trade weighted and USD-JPY rates
		]{Japanese government bond yield curve}\\
		\indent \begin{tikzpicture}
			\begin{axis}[date coordinates in=x, xticklabel={\year}, \lineplotsettings 
			xtick={
				{2014-01-01},{2015-01-01},{2016-01-01},{2017-01-01}},
		    minor xtick={
			...
			\addplot[thick, color=orange] table [x=Date, y=Rate, col sep=comma] 
				{data/fx.csv} node[pos=0.93,pin=240:{USD-JPY}] {};	
			...
			\addplot[ultra thick, dashed, color=blue!50!black] table [x=Date, y=NEER, col sep=comma] 
				{data/fx.csv} node[pos=0.9,pin=90:{Nominal effective}] {};	 	
			\node[below, shift=({2.7cm,-0.1cm})] {\color{black!80} \input{data/usdjpy.txt}};
			\node[align=left, below, shift=({2.8cm,4.0cm})] {\color{black!80} Values indexed to 2014=1; \\ Effective rates are BOJ trade-weighted rates.};
			\end{axis}
		\end{tikzpicture}\hfill
		\begin{tikzpicture}[trim axis right]
			\begin{axis}[
			...
			\addplot[thick, mark=*, mark options={fill=white},
				...
				node[pos=0.89,pin=90:{\color{black!80} Year ago}] {};
			\addplot[thick, mark=*, mark options={fill=white},
    			color=blue!65!black!60] 
				table [x=number, y=prev5, col sep=comma] {data/jgb.csv}
				node[pos=0.36,pin={[pin distance=3mm]90:{\color{black!80} Five years ago}}] {};			
			\addplot[ultra thick, mark=*, mark options={fill=white},
				...
				node[pos=0.7,pin=280:{\textbf{Most recent}}] {};		
