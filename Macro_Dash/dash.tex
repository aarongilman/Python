...
%   Settings    %
	...
	% Main style			
		\fancypagestyle{main}{
			\headheight = 22pt		
			\fancyhf{} \lhead{\LARGE{\textcolor{cyan!30!blue}{\textbf{Macro and Markets Dashboard:}} 
				United States}} \rhead{\footnotesize \textcolor{cyan!80!blue}{\textbf{Updated:}} \today}
			\lfoot{\textcolor{cyan!30!blue}{\textbf{Contact:}} Brian W. Dew} \cfoot{} \rfoot{}}
	...
	% Line plot settings
		\newcommand{\lineplotsettings}{yticklabel style={text width=3em},
			...
			minor xtick={{2007-01-01},{2009-01-01},{2011-01-01},{2013-01-01},{2015-01-01}},
...
\section{Inflation and Prices}
	...
	% CPI Components
		\begin{tikzpicture}[trim axis right]
		    ...
		    \bbar{x}{0}, legend style={at={(0.75,0.55)}}, legend cell align=left,
...
\section{Markets, Interest Rates, and Other Indicators}
	...
	% Earnings per share
		\hspace{-10mm}\begin{tikzpicture}
			  ...
			  \draw[thick, black!25] ({rel axis cs:0,0.02}-|{axis cs:0,0.02}) -- ({rel axis cs:0,1}-|{axis cs:0,0});
	...
	% Footer: EPS and Extras	
		\cf[S\&P Dow Jones Indices:
			...
			{S\&P 500 growth forecasts (.xls)}]
				{Retrieved from FRED, Quandl, and University of Michigan}
\end{document}