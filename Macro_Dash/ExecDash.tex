	...
	% CPI Components
		\begin{tikzpicture}[trim axis right]
		  	\begin{axis}[\xbarplotsettings 
				yticklabel style={align=right, text width=3.3cm, style={black!70}, text height=1.4ex},  width=7cm, 
